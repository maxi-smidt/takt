...
function App() {
  ...
  return session ? (session.user?.is_admin ? <Dashboard session={session} refreshSession={refreshSession} /> : <Portal session={session} refreshSession={refreshSession} />) : <Login onLogin={refreshSession} />;
}
export default App;
